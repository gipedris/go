...
func main() {
	...
	//Case с проваливаниямию. Проваливания выполняют даже ложные кейсы
	// В момент выполнения инструкции fallthrought уследующего кейса не проверяется условие
...
outloop:
	for {
		...
		switch {
		case i%2 == 0:
			fmt.Printf("value i is %d and its even\n", i)
			break outloop
		}
	}
	fmt.Println("THE END.")
